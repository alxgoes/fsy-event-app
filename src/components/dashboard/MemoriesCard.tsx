      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 pb-5 border-b-2 border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-3.5">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#06D6A0] text-slate-950 border-2 border-slate-900 dark:border-slate-700 shadow-brutal-sm">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="rounded-full bg-pink-100 dark:bg-pink-950 px-2.5 py-0.5 text-[10px] font-black text-[#FF6B8B] border border-pink-200 dark:border-pink-800">
                  #FSYRibeirao2
                </span>
              </div>
          ...
          <div className="flex items-center">
            <div className="grid grid-cols-2 w-full md:w-auto p-1 rounded-2xl bg-slate-100 dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 shadow-brutal-sm gap-1">
              <button
                type="button"
                onClick={() => setActiveTab("drive")}
                className={`flex items-center justify-center gap-2 py-2 px-4 text-xs font-black rounded-xl transition-all ${
                  activeTab === "drive"
                    ? "bg-[#4361EE] text-white shadow-sm border border-slate-900/20"
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 py-2 px-4 text-xs font-black rounded-xl transition-all ${
                  activeTab === "instagram"
                    ? "bg-[#FF6B8B] text-white shadow-sm border border-slate-900/20"
                    : "text-slate-600 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white"
                }`}
              >
