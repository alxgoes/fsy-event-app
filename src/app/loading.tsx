...
export default function Loading() {
  return (
    <div className="min-h-screen bg-fsy-watermark flex flex-col items-center justify-center p-6 text-slate-900 selection:bg-[#FFE48A]">
      <div className="relative flex flex-col items-center max-w-sm w-full p-8 rounded-3xl border-2 border-slate-900 bg-white dark:bg-slate-900 shadow-brutal-md text-center space-y-4">
        {/* Animated FSY Temple Logo Badge */}
        <div className="relative flex h-20 w-16 items-center justify-center p-1 rounded-2xl bg-[#EFEFE7] dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 shadow-brutal-sm animate-bounce">
